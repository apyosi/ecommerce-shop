    ...
    <nav className="fixed top-0 w-full flex flex-col justify-evenly p-2  md:flex-row   h-[auto] z-10 bg-purple-700">
      <div className="flex mx-auto p-3 items-center justify-evenly">
        <div className="sm:mx-[-110px]">
          <Link to="/">
            <h1 className=" text-4xl text-white lg:text-4xl md:text-3xl px-5 ">
              ShopAddict
            </h1>
          </Link>
        </div>
        <div
          className="fixed left-7 md:hidden text-white w-[80px]"
          onClick={() => setMenu(!menu)}
        >
        ...
        <NavLink to="/cart" className="text-2xl text-white px-2 m-1 rounded-xl">
          <div className="fixed text-white z-40 w-[80px] sm:right-[-20px] right-1">
            ...
            <span className=" absolute text-gray-700 left-5 top-6 w-6 rounded-full bg-white">
              8
            </span>
          </div>
        </NavLink>
      ...
      <ul className="hidden lg:items-center md:flex sm:items-center ">
        <li className="link sm:mx-[-15px]">
          <NavLink
            to="/"
            className="text-2xl text-white px-2 m-1 rounded-xl sm:text-[18px] lg:pl-5 lg:text-xl "
          >
            {" "}
            Home
          </NavLink>
